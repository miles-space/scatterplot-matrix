This is an open source react application that was created using create-react-app. It is a scatterplot matrix with correlation checking and a drag and drop feature built in.  
...
4. npm run start
5. drag and drop in a csv file **Note: the csv file needs to have headers in its current state to parse correctly**

## Deployment

1. npm run build 
2. npm install serve 
3. serve -s build **Note: this will run on port 5000**

## Below is a link the victory-chart which is the charting library used in the application
(https://formidable.com/open-source/victory/docs/victory-chart/)

below is all of the create-react-app documentation which goes more in detail on deployment.
